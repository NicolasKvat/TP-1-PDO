        ...
        <div class="form p-5 shadow mb-5">
            ...
            <div class="row justify-content-center pt-3">
                <div class="col-4">
                    ...
                    <a href="?page=articles" class="btn btn-outline-secondary btn-block">NON</a>
                </div>
                <div class="col-4">
                    <!--Sinon on retourne sur la page d'accueil-->
                    <a href="?page=deleteArticleConfirm&delete=<?= $Article->getId() ?>" class="btn btn-outline-secondary btn-block">OUI</a>
                </div>
            </div>
        </div>
    </div>
